...
sap.ui.define([
   ...
   * @public
   */
  cModel.prototype.bindProperty = (sPath, oContext, mParameters) => {
   ...
   * @public
   */
  cModel.prototype.bindList = (sPath, oContext, aSorters, aFilters, mParameters) => {
    let oBinding;
    if (oContext) {
   ...
   * @public
   */
  cModel.prototype.createBindingContext = (sPath, oContext, mParameters, fnCallBack) => {
